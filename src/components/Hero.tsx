  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-32 text-center">
        ...
        <h1 className="text-5xl md:text-7xl font-bold text-white mb-8 leading-[1.15] md:leading-[1.2]">
          Transformando Negócios por Meio da
          <span className="mt-2 block pb-2 text-transparent bg-clip-text bg-gradient-to-r from-cyan-400 to-blue-400">
